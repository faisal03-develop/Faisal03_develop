...
export default function quote() {
  return (
    <>
    <div className="mt-50 md:mt-36 mx-auto text-center font-(family-name:--font-firaCode) text-sm md:text-2xl p-8 border-2 border-(--gray) w-44 md:w-[730px] md:h-[95px] relative">
